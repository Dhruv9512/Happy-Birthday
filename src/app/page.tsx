...
import { Heart, Gift } from 'lucide-react'; // Removed Camera icon
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground p-4 md:p-8">
      ...
      <main className="flex-grow flex flex-col items-center gap-16">
        ...
        {/* My Love For You Section - REVISED */}
        <section className="w-full max-w-5xl fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Card for "I" */}
            <Card className="overflow-hidden shadow-lg border-accent border-dashed border bg-card/50 hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-4 flex flex-col items-center text-center">
                <div className="relative w-full aspect-square mb-4 rounded-lg overflow-hidden border-2 border-primary/50 shadow-inner">
                  <Image
                    data-ai-hint="Couple looking into each others eyes close up"
                ...
                <p className="text-6xl font-heading font-bold text-primary mt-2">I</p>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden shadow-lg border-accent border-dashed border bg-card/50 hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-4 flex flex-col items-center text-center">
                <div className="relative w-full aspect-square mb-4 rounded-lg overflow-hidden border-2 border-primary/50 shadow-inner">
                  <Image
                    data-ai-hint="Holding hands sunset silhouette beach"
                ...
                <p className="text-6xl font-heading font-bold text-primary mt-2 flex items-center gap-2">
                  LOVE
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden shadow-lg border-accent border-dashed border bg-card/50 hover:shadow-xl transition-shadow duration-300">
              <CardContent className="p-4 flex flex-col items-center text-center">
                <div className="relative w-full aspect-square mb-4 rounded-lg overflow-hidden border-2 border-primary/50 shadow-inner">
                  <Image
                    data-ai-hint="Smiling couple selfie happy park"
                ...
                <p className="text-6xl font-heading font-bold text-primary mt-2">YOU</p>
              </CardContent>
            </Card>
          </div>
